...
from model.nets.frcnn import FasterRCNN
from model.utils.utils import DecodeBox, get_new_img_size
class FRCNN(object):
    _defaults = {
        # "model_path"    : 'D:\garbagesorting\\faster-rcnn-pytorch-master\model_data\wwww.pth',
        # "model_path": 'D:\garbagesorting2\\faster-rcnn-pytorch-master\model_data\wwww.pth',
        # "classes_path"  : 'D:\garbagesorting2\\faster-rcnn-pytorch-master\model_data\\voc_classes.txt',
        "model_path": 'model_data/Epoch100-Total_Loss0.7328-Val_Loss1.1818.pth',
    ...
    def detect_image(self, image):
        ...
        old_image = copy.deepcopy(image)                # 原始图片的长、宽、整张
